...
async function sendEmailNotification(ticketId: string, companyId: string) {
  ...
  return new Promise((resolve) => {
    ...
    // FIX: La promesa nunca se resolvía, causando que el endpoint quedara colgado.
    // Esto bloqueaba la respuesta al frontend, dejando el botón en estado "Resolviendo...".
    resolve(true);
  });
}
